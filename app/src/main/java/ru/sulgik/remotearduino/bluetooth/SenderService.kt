...
import ru.sulgik.remotearduino.Receiver.Companion.RESULT_INVALID_INTENT
import ru.sulgik.remotearduino.Receiver.Companion.RESULT_OK
import ru.sulgik.remotearduino.Receiver.Companion.baseIntent
...
class SenderService : IntentService("BluetoothService") {
    ...
    companion object{
        ...
        val asIntent get() = Intent("ru.sulgik.remotearduino.bluetooth.BluetoothService").setPackage("ru.sulgik.remotearduino")
        ...
        const val BROADCAST = "ru.sulgik.remotearduino.bluetooth:BluetoothService:BROADCAST:999999"
