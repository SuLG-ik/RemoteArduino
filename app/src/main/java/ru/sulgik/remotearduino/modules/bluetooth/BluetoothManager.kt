...
import ru.sulgik.remotearduino.base.Receiver
import android.bluetooth.BluetoothAdapter
import android.content.*
import androidx.appcompat.app.AppCompatActivity
import ru.sulgik.remotearduino.modules.log.SystemLog
import ru.sulgik.remotearduino.base.ReceiverLifecycleObserver
import ru.sulgik.remotearduino.modules.bluetooth.livedatas.BluetoothState
import ru.sulgik.remotearduino.modules.bluetooth.livedatas.DiscoveredDevices
import ru.sulgik.remotearduino.modules.bluetooth.livedatas.DiscoveringState
...
class BluetoothManager {
    ...
    fun setOnBluetoothServiceListener(activity: AppCompatActivity, listener: BluetoothServiceListener){
        ...
        activity.lifecycle.addObserver(
            ReceiverLifecycleObserver(
                activity,
                bluetoothServiceReceiver,
                bluetoothServiceReceiver.filter
            )
        )
